class GetCustomTourByIdModel {
  ...
  factory GetCustomTourByIdModel.fromJson(Map<String, dynamic> json) {
    return GetCustomTourByIdModel(
      ...
      sentRequests: json["sentRequests"] != null ? List<dynamic>.from(json["sentRequests"].map((x) => x)) : null,
      respondingGuides: json["respondingGuides"] != null ? List<dynamic>.from(json["respondingGuides"].map((x) => x)) : null,
