...
//   "client_email": "firebase-adminsdk-mmrf1@sawahchat.iam.gserviceaccount.com",
//   "client_id": "116711881967709691100",
//   "auth_uri": "https://accounts.google.com/o/oauth2/auth",
//   "token_uri": "https://oauth2.googleapis.com/token",
//   "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
//   "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-mmrf1%40sawahchat.iam.gserviceaccount.com",
...
class FireData {
  final FirebaseFirestore firestore = FirebaseFirestore.instance;
Future<String> creatRoom(String userId, String? token) async {
    createUser(userId, token);
    List<String> members = [myUid, userId]..sort((a, b) => a.compareTo(b));
    QuerySnapshot roomExist = await firestore
        .collection('rooms')
        .where('members', arrayContains: members)
  ...
  Future<String> createUser(String userId, String? token) async {
    ...
    if (userExist.docs.isEmpty) {
      await firestore.collection('User').doc(userId.toString()).set(user.toJson());
    } else {
      await firestore.collection('User').doc(userId.toString()).update(user.toJson());
    }
    return token ?? '';
  }
